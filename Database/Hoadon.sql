...
BEGIN TRY
	...
	SELECT @TONGTIENCANTT = SUM(KHDT.TONGTIEN) FROM KHDIEUTRI KHDT
										  WHERE EXISTS(SELECT 1 FROM @LIST_MAKHDT LIST WHERE LIST.MAKHDT = KHDT.MAKHDIEUTRI)
	SET @SOTIENTHOI = @TONGTIENCANTT - @SOTIENNHAN
