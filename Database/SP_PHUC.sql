		...
		IF @MAKH IS NULL
			BEGIN
				SELECT 
					...
					GHICHU,
					CASE
						WHEN MAHDTT IS NOT NULL THEN N'Đã trả tiền'
						ELSE N'Chưa trả tiền'
					END AS TRANGTHAI_TIEN,
					CASE
						WHEN TRANGTHAI = 1 THEN N'Đang điều trị'
						WHEN TRANGTHAI = 2 THEN N'Đã hoàn thành'
						WHEN TRANGTHAI = 3 THEN N'Đã hủy'
			...
			BEGIN
				SELECT 	MAKHDIEUTRI,
					...
					CASE
						...
						ELSE N'Không xác định'
					END AS TRANGTHAI
					FROM KHDIEUTRI WHERE @MAKH = MAKHDIEUTRI
			END
	END
GO
...
/*SELECT KHDT.MAKHDIEUTRI,
					...
					END AS TRANGTHAI_TIEN,
					KHDT.MOTAKH, KHDT.GHICHU
					FROM KHDIEUTRI KHDT WHERE 1 = 1 AND KHDT.NGAYDIEUTRI = 2023-1-10
...
SELECT KHDT.MAKHDIEUTRI,
					...
					END AS TRANGTHAI_TIEN,
					KHDT.MOTAKH, KHDT.GHICHU
					FROM KHDIEUTRI KHDT WHERE 1 = 1 AND KHDT.MAHSBN = 2


*/


/*DECLARE @SampleTable THUOCARRAY;
INSERT INTO @SampleTable (MATHUOC, SOLUONG)
VALUES (1, 10), (2, 5), (3, 8); -- Điền dữ liệu mẫu vào bảng kiểu
EXEC SP_ADD_CHI_TIET_DON_THUOC 12,'', @SampleTable
...
SELECT KHDT.MAKHDIEUTRI,
					...
					END AS TRANGTHAI_TIEN,
					KHDT.MOTAKH, KHDT.GHICHU
					FROM KHDIEUTRI KHDT WHERE 1 = 1 AND KHDT.NGAYDIEUTRI = '2023-1-10' AND KHDT.TRANGTHAI = 1
*/